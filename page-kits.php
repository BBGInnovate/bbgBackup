								...
								<div class="bbg__contact-card">
									<div class="bbg__contact-card__text">
										<?php
											...
											echo "<button id='btnSignup' onclick=\" toggleForm();  \" class='usa-button-secondary bbg__kits__inquiries__button--half' style='width:100%' data-enabled='enabled'>Sign up to receive updates</button>";
