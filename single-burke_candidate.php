...
<?php
	...
	$burkeProfileObj = get_post_meta( $id, 'burke_award_info' );

	var_dump( $burkeProfileObj );

	// if ( $burkeProfileObj ) {
	// 	echo get_post_field( "burke_year_of_eligibility" );
	// }
...
?>
							<div class="bbg__profile-photo">
								<img src="<?php
		echo $profilePhoto; ?>" class="bbg__profile-photo__image"/>
							</div>
						<?php
	}
	else {
		$noProfilePhoto = "max-width: none;";
						...
						<div class="bbg__profile-title" style="<?php
	echo $noProfilePhoto; ?>">
	...
	echo $twitterURL; ?>">
					...
					<div class="entry-content bbg__article-content <?php
	echo $featuredImageClass; ?>">
						<?php
	the_content(); ?>
