<?php
/**
 * The template for displaying basic profiles.
 *
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class( "bbg__article" ); ?>>
				<?php
					...
					if ( has_post_thumbnail() && ( $hideFeaturedImage != 1 ) ) {
						...
						echo '<div class="single-post-thumbnail clear bbg__article-header__thumbnail--large bbg__article-header__banner bbg__article-header__banner--profile" style="background-image: url('.$src[0].'); background-position: '.$bannerPosition.'">';
						echo '</div>';
