...
if ($pageTitle=="Former Governors") {
	...
	$formerGovernorsLink = '<a href="' .  get_permalink( get_page_by_path( 'about-the-agency/history/former-governors/' ) ) .'">Explore the list of former Governors »</a>';
}
...
while ( $custom_query->have_posts() )  {
	...
	if (  (get_the_title() != "Special Committees") && (($pageTitle=="The Board" && $active) || ($pageTitle=="Former Governors" && (!isset($active) || $active=="" || !$active ))  )) {
