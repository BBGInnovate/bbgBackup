		...
		<main id="bbg-home" class="site-content bbg-home-main" role="main">
			...
			<?php
					...
					*/
					...
					//echo do_shortcode('[wp_posts_carousel template="simple.css" post_types="burke_candidate" all_items="7" show_only="id" exclude="" posts="" ordering="asc" categories="" relation="and" tags="" show_title="true" show_created_date="false" show_description="false" allow_shortcodes="false" show_category="true" show_tags="false" show_more_button="false" show_featured_image="true" image_source="thumbnail" image_height="100" image_width="100" items_to_show_mobiles="1" items_to_show_tablets="2" items_to_show="5" slide_by="1" margin="5" loop="true" stop_on_hover="true" auto_play="false" auto_play_timeout="1200" auto_play_speed="400" nav="true" nav_speed="800" dots="true" dots_speed="150" lazy_load="false" mouse_drag="false" mouse_wheel="false" touch_drag="true" easing="linear" auto_height="true" custom_breakpoints=""]');
			?>
